...
export const PORTAL_PRODUCTS = [
  ...
  {
    slug: 'viesproof', name: 'Vatidence', icon: 'BadgeCheck', color: 'blue',
    ...
    url: 'https://vatidence.nyttolabs.com/', canonicalUrl: 'https://vatidence.nyttolabs.com/',
  ...
  },
  {
    ...
    category: 'business', group: 'subdomain', status: 'Live',
    ...
    action: 'Sell a file', detail: 'Card payments via Stripe · 5% platform fee',
  ...
  },
  {
    ...
    tagline: 'Turn the support mess into a sealed timeline PDF they can\'t ignore.',
