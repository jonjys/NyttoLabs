...
export const HOME_TITLE = 'Nytto Labs — reorder labels, EU VAT checks, file sales'
export const HOME_DESCRIPTION = 'CycleTag QR reorder labels, Vatidence EU VAT checks with a VIES consultation number, and Curl-to-Buy file sales. Swedish software, F-tax approved.'

export const PUBLIC_ROUTES = [
  { path: '/', title: HOME_TITLE, description: HOME_DESCRIPTION },
  { path: '/products', title: 'Products — Nytto Labs', description: 'Buy CycleTag reorder labels, pay for a Vatidence VAT check, or sell a file with Curl-to-Buy. Swedish software, F-tax.' },
