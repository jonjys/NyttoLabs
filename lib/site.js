...
export const PUBLIC_ROUTES = [
  ...
  { path: '/products', title: 'Products — Nytto Labs', description: 'The public Nytto Labs portfolio: CycleTag, VIESProof, GateZero, and Failclosed — proof of what the company builds.' },
...
export function pageMetadata({ title, description, path }) {
  ...
  return {
    ...
    openGraph: {
      ...
      siteName: 'Nytto Labs',
      type: 'website',
      images: [{ url: siteUrl('/opengraph-image'), width: 1200, height: 630, alt: 'Nytto Labs — nine focused software products' }],
    },
