...
export const PUBLIC_ROUTES = [
  ...
  { path: '/products', title: 'Products — Nytto Labs', description: 'The public Nytto Labs portfolio: CycleTag, VIESProof, Curl-to-Buy, GateZero, and Failclosed — proof of what the company builds.' },
