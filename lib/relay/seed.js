...
// Real Nytto Labs portfolio (authoritative scope).
// Netfold / Skrivklart / Invoic are intentionally absent.
  ...
  return [
    {
      ...
      name: 'CycleTag',
      slug: 'cycletag',
      description: 'Stateless QR reorder labels that take people straight to the correct replacement product.',
      url: 'https://cycletag.eu/',
    ...
    },
    {
      ...
      name: 'VIESProof',
      slug: 'viesproof',
      description: 'Focused EU VAT number verification with clean, exportable proof for finance teams.',
      url: 'https://www.viesproof.eu/',
    ...
    },
    {
      ...
      name: 'GateZero',
      slug: 'gatezero',
      description: 'Technical infrastructure product for developers and platform teams.',
      url: 'https://getgatezero.com/',
...
// Idempotent seeding. Applications are always ensured; demo data only when DEMO_MODE.
